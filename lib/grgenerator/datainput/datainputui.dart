            ...
            body: Padding(
              ...
              child: BlocBuilder<InputBloc, InputState>(
                builder: (context, state) {
                  return Column(
                    children: [
                      const Text("Data Input", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 10),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            state.isAccuracyValid ? "Create QR" : "Waiting for better Accuracy....",
